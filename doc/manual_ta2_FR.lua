return {
  titles = {
    "1,TA2 : Âge de la Vapeur",
    "2,Machine à vapeur",
    "3,TA2 Boîte à feu / Firebox",
    "3,TA2 Chaudiere",
    "3,TA2 Cylindre / Cylinder",
    "3,TA2 Volant d'inertie / Flywheel",
    "3,TA2 Conduites de vapeur / Steam Pipe",
    "3,TA2 Axes d'entraînement / TA2 Drive Axle",
    "3,TA2 Générateur électrique / TA2 Power Generator",
    "2,TA2 Stockage d'énergie",
    "3,TA2 Treuil / TA2 Winch",
    "3,TA2 Caisse de poids / TA2 Weight Chest",
    "3,TA2 Embrayage / TA2 Clutch",
    "2,Pousser et trier les objets",
    "3,Tubes / TechAge Tube",
    "3,Concentrateur de tubes / Tube Concentrator",
    "3,TA2 Poussoir / Pusher",
    "3,TA2 Distributeur / Distributor",
    "2,Installation de lavage de gravier",
    "3,TA2 Laveur de gravier / Gravel Rinser",
    "2,Concassage\\, broyage et tamisage de la pierre",
    "3,TA2 Concasseur / Quarry",
    "3,TA2 Moulin / Grinder",
    "3,TA2 Tamis à gravier / Gravel Sieve",
    "2,Production d'items",
    "3,TA2 Autocrafter",
    "3,TA2 Usine d'électronique / Electronic Fab",
    "2,Autres blocs",
