return {
  ...
  texts = {
    ...
    "\n"..
    "\n",
    "TA5 SSD является промежуточным компонентом для создания TA5 Дигитайзера. Он может быть изготовлен только на TA4 Электронной фабрике из 8 чипов RAM TA4 и 1 кремниевой подложки TA4.\n"..
    "\n"..
    "\n"..
    "\n",
    "",
