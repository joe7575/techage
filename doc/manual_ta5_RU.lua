return {
  ...
  texts = {
    ...
    "\n"..
    "Дигитайзер может быть удалён киркой только при полностью пустом внутреннем хранилище. Используйте беспроводную отвёртку для удаления\\, если в нём есть предметы.\n"..
    "\n"..
