return {
  ...
  texts = {
    ...
    "\n",
    "",
    "TA5 Дигитайзер — это блок хранения предметов высокой ёмкости\\, который цифровым образом сохраняет предметы из соседних инвентарей. Он может работать в двух режимах (pull/push) и управляет до 16 различными типами предметов с до 100 000 предметов на слот.\n"..
    "\n"..
    ...
    "\n"..
    "Дигитайзер может быть удалён киркой только при полностью пустом внутреннем хранилище. Используйте беспроводную отвёртку для удаления в любое время — хранимые предметы сохраняются в метаданных итема и автоматически восстанавливаются при установке блока с помощью беспроводной отвёртки.\n"..
    "\n"..
