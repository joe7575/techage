return {
  ...
  texts = {
    ...
    "\n"..
    "\n",
    "TA5 SSD является промежуточным компонентом для создания TA5 Дигитайзера. Изготавливается из 8 чипов RAM TA4, расположенных вокруг кремниевой подложки TA4 в сетке крафта.\n"..
    "\n"..
    "\n"..
    "\n",
    "",
