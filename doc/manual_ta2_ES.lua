return {
  titles = {
    "1,TA2: Edad del Vapor",
    "2,Máquina de Vapor",
    "3,Caja de Fuego TA2",
    "3,Caldera TA2",
    "3,Cilindro TA2",
    "3,Volante de Inercia TA2",
    "3,Tuberías de Vapor TA2",
    "3,Eje de Transmisión TA2 / Caja de Cambios TA2",
    "3,Generador de Energía TA2",
    "2,Almacenamiento de energía TA2",
    "3,Cabrestante TA2",
    "3,Cofre de Pesas TA2",
    "3,Embrague TA2",
    "2,Empujar y clasificar objetos",
    "3,Tubo TechAge",
    "3,Concentrador de Tubos",
    "3,Empujador TA2",
    "3,Distribuidor TA2",
    "2,Lavador de Grava",
    "3,Enjuagadora de Grava TA2",
    "2,Excavar piedra\\, triturar y cribar",
    "3,Cantera TA2",
    "3,Trituradora TA2",
    "3,Criba de Grava TA2",
    "2,Producir Objetos",
    "3,Fabricante Automático TA2",
    "3,Fábrica Electrónica TA2",
    "2,Otros bloques",
    "3,Muestreador de Líquidos TA2",
    "3,Cofre Protegido TA2",
    "3,Bloque de Carga Forzada Techage",
    "3,Resumen de administración de carga forzada",
  },
  texts = {
