return {
  titles = {
    "1,TA4: Presente",
    "2,Turbina eólica",
    "3,Turbina eólica TA4",
    "3,Nacelle da turbina eólica TA4",
    "3,Lâmpada de sinalização de turbina eólica TA4",
    "3,Pilar TA4",
    "2,Sistema Solar",
    "3,Módulo solar TA4",
    "3,Módulo de transporte solar TA4",
    "3,Inversor solar TA4",
    "3,Cabo de baixa potência TA4",
    "3,Caixa de junção de baixa tensão TA4",
    "3,Célula solar para lâmpadas de rua TA4",
    "2,Armazenamento de energia térmica",
    "3,Trocador de calor TA4",
    "3,Turbina TA4",
    "3,Gerador TA4",
    "3,Entrada do tubo TA4",
    "3,Tubo TA4",
    "2,Distribuição de energia",
    "3,Transformador de isolamento TA4",
    "3,Medidor elétrico TA4",
    "3,Laser TA4",
    "2,Hidrogênio",
    "3,Eletrolisador",
    "3,Célula de combustível",
    "2,Reator químico",
    "3,Dosador TA4",
    "3,Reator TA4",
    "3,Tubo de enchimento TA4",
    "3,Suporte do reator TA4",
    "3,Base do reator TA4",
    "3,Silo TA4",
    "2,Controlador ICTA",
    "3,Controlador TA4 ICTA",
    "3,Bateria",
    "3,Exibição do TA4",
    "3,TA4 Display XL",
    "3,Torre de sinalização TA4",
    "2,Controlador TA4 Lua",
    "3,Servidor TA4 Lua",
    "3,Caixa do sensor TA4 / baú",
    "3,Terminal do controlador TA4 Lua",
    "2,Módulos de lógica/comutação TA4",
    "3,Botão/interruptor TA4",
    "3,Botão TA4 2x",
    "3,Botão TA4 4x",
    "3,Lâmpada de sinalização TA4 2x",
    "3,Lâmpada de sinalização TA4 4x",
    "3,Detector de jogadores TA4",
    "3,Coletor de estado TA4",
    "3,Detector TA4",
    "3,Detector de nó TA4",
    "3,Detector de carga de armazenamento de energia TA4",
    "3,Sensor de olhar TA4",
    "3,Sequenciador TA4",
    "2,Controlador de movimento/volta",
    "3,Controlador de movimento TA4",
    "3,Controlador de giro TA4",
    "2,Lâmpadas TA4",
    "3,Luz de cultivo LED TA4",
    "3,Lâmpada de rua TA4",
    "3,Lâmpada industrial de LED TA4",
    "2,Filtro líquido TA4",
    "3,Camada de base",
    "3,Camada de cascalho",
    "3,Camada de enchimento",
    "2,Colisor TA4 (acelerador de partículas)",
    "3,Detector",
    "3,Controle / Terminal TA4",
    "3,Resfriamento e energia",
    "3,Construção",
    "2,Mais blocos TA4",
    "3,Bloco de receitas TA4",
    "3,TA4 Autocrafter",
    "3,Tanque TA4",
    "3,Bomba TA4",
    "3,Aquecedor de forno TA4",
    "3,Bomba d'água TA4 (obsoleta)",
    "3,Entrada de água TA4",
    "3,Tubo TA4",
    "3,TA4 Pusher",
    "3,Peito TA4",
    "3,Baú TA4 8x2000",
    "3,Distribuidor TA4",
    "3,Distribuidor de alto desempenho TA4",
    "3,Peneira de cascalho TA4",
    "3,Moedor TA4",
    "3,Pedreira TA4",
    "3,Fab. eletrônica TA4",
    "3,Injetor TA4",
    "3,Reciclador TA4",
  },
  texts = {
