...
techage.register_liquid("techage:ta3_barrel_bitumen", "techage:ta3_barrel_empty", techage.volume_barrel, "techage:bitumen")
techage.register_liquid("techage:ta3_barrel_fueloil", "techage:ta3_barrel_empty", techage.volume_barrel, "techage:fueloil")
techage.register_liquid("techage:ta3_barrel_naphtha", "techage:ta3_barrel_empty", techage.volume_barrel, "techage:naphtha")
techage.register_liquid("techage:ta3_barrel_gasoline", "techage:ta3_barrel_empty", techage.volume_barrel, "techage:gasoline")
techage.register_liquid("techage:ta3_cylinder_large_gas", "techage:ta3_cylinder_large", techage.volume_big_gascylinder, "techage:gas")
techage.register_liquid("techage:ta4_cylinder_large_isobutane", "techage:ta3_cylinder_large", techage.volume_big_gascylinder, "techage:isobutane")

techage.register_liquid("techage:ta3_canister_oil", "techage:ta3_canister_empty", techage.volume_canister, "techage:oil_source")
techage.register_liquid("techage:ta3_canister_bitumen", "techage:ta3_canister_empty", techage.volume_canister, "techage:bitumen")
techage.register_liquid("techage:ta3_canister_fueloil", "techage:ta3_canister_empty", techage.volume_canister, "techage:fueloil")
techage.register_liquid("techage:ta3_canister_naphtha", "techage:ta3_canister_empty", techage.volume_canister, "techage:naphtha")
techage.register_liquid("techage:ta3_canister_gasoline", "techage:ta3_canister_empty", techage.volume_canister, "techage:gasoline")
techage.register_liquid("techage:ta3_cylinder_small_gas", "techage:ta3_cylinder_small", techage.volume_small_gascylinder, "techage:gas")
techage.register_liquid("techage:ta4_cylinder_small_isobutane", "techage:ta3_cylinder_small", techage.volume_small_gascylinder, "techage:isobutane")
