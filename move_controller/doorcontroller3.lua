...
minetest.register_node("techage:ta3_doorcontroller3", {
	description = S("TA3 Door Controller III"),
	tiles = {
	...
	after_place_node = function(pos, placer, itemstack)
		...
		logic.after_place_node(pos, placer, "techage:ta3_doorcontroller3", S("TA3 Door Controller III"))
		logic.infotext(meta, S("TA3 Door Controller III"))
		local nvm = techage.get_nvm(pos)
...
techage.register_node({"techage:ta3_doorcontroller3"}, {
...
minetest.register_craft({
	type = "shapeless",
	output = "techage:ta3_doorcontroller3",
	recipe = {"techage:ta3_doorcontroller2"},
})
