...
local PWR_NEEDED = 90
local PWR_UNITS_PER_NYTROGEN_ITEM = 80
local CAPACITY = 200
...
local function formspec(self, pos, nvm)
	...
	return "size[6,4]" ..
		...
		"label[0.2,-0.1;" .. minetest.colorize( "#000000", S("Nitrogen collector")) .. "]" ..
...
local State = techage.NodeStates:new({
	node_name_passive = "techage:ta4_nitrogen",
	node_name_active = "techage:ta4_nitrogen_on",
	cycle_time = CYCLE_TIME,
	standby_ticks = STANDBY_TICKS,
	formspec_func = formspec,
	infotext_name = S("TA4 Nitrogen collector"),
	can_start = can_start,
...
local function generating(pos, nvm)
	...
	if nvm.taken > 0 then
		...
		if nvm.num_pwr_units >= PWR_UNITS_PER_NYTROGEN_ITEM then
			nvm.liquid.amount = nvm.liquid.amount + 1
			nvm.liquid.name = "techage:nitrogen"
			nvm.num_pwr_units = nvm.num_pwr_units - PWR_UNITS_PER_NYTROGEN_ITEM
		end
	end
end

-- converts power into nitrogen
...
local function after_place_node(pos)
	...
	nvm.running = false
	nvm.num_pwr_units = 0
	local number = techage.add_node(pos, "techage:ta4_nitrogen")
...
minetest.register_node("techage:ta4_nitrogen", {
	description = S("TA4 Nitrogen collector"),
	tiles = {
		...
		"techage_filling_ta4.png^techage_frame_ta4.png^techage_appl_nitrogen.png^techage_appl_ctrl_unit.png^[transformFX",
		"techage_filling_ta4.png^techage_frame_ta4.png^techage_appl_nitrogen.png^techage_appl_ctrl_unit.png",
	},
...
minetest.register_node("techage:ta4_nitrogen_on", {
	description = S("TA4 Nitrogen collector"),
	tiles = {
		-- up, down, right, left, back, front
		"techage_filling_ta4.png^techage_frame_ta4_top.png^techage_appl_arrow.png",
		...
		"techage_filling_ta4.png^techage_frame_ta4.png^techage_appl_hole_electric.png",
		{
			name = "techage_filling4_ta4.png^techage_frame4_ta4.png^techage_appl_nitrogen4.png^techage_appl_ctrl_unit4.png^[transformFX",
		...
		{
			name = "techage_filling4_ta4.png^techage_frame4_ta4.png^techage_appl_nitrogen4.png^techage_appl_ctrl_unit4.png",
			backface_culling = false,
			animation = {
				type = "vertical_frames",
				aspect_w = 32,
...
liquid.register_nodes({"techage:ta4_nitrogen", "techage:ta4_nitrogen_on"}, Pipe, "tank", {"R"}, liquid_def)
power.register_nodes({"techage:ta4_nitrogen", "techage:ta4_nitrogen_on"}, Cable, "con", {"L"})

techage.register_node({"techage:ta4_nitrogen", "techage:ta4_nitrogen_on"}, {
